!(function (e, r) {
  ...
  function t(r, t, n) {
    ...
    function f(e) {
      ...
      return (
        (t =
          m.config.classTo === m.config.errorTextParent
            ? r
            : r.querySelector(m.errorTextParent)) &&
          ((n = t.querySelector("." + s)) ||
            (((n = document.createElement(m.config.errorTextTag)).className =
              s + " " + m.config.errorTextClass),
            t.appendChild(n),
    ...
    function c(e) {
      var r = f(e),
        ...
        n = r[1];
      t &&
        (t.classList.remove(m.config.successClass),
        t.classList.add(m.config.errorClass)),
        n &&
    ...
    function p(e) {
      var r = (function (e) {
        ...
        return (
          t &&
            (t.classList.remove(m.config.errorClass),
            t.classList.remove(m.config.successClass)),
    ...
    return (
      (function (e, r, t) {
        e.setAttribute("novalidate", "true"),
          (m.form = e),
          (m.config = (function (e, r) {
            for (var t in r) t in e || (e[t] = r[t]);
            return e;
          })(r || {}, i)),
          (m.live = !(!1 === t)),
          (m.fields = Array.from(e.querySelectorAll(a)).map(
            function (e) {
              var r = [],
                t = {},
                n = {};
                ...
                [].forEach.call(e.attributes, function (e) {
                  if (/^data-pristine-/.test(e.name)) {
                    ...
                    if (i.endsWith("-message"))
                      return void (n[i.slice(0, i.length - 8)] = e.value);
        ...
        !0 !== r &&
          ...
          (r instanceof HTMLElement
            ...
            : (r instanceof NodeList ||
                r instanceof (window.$ || Array) ||
                r instanceof Array) &&
              (n = Array.from(r).map(function (e) {
                return e.pristine;
              })));
        var i = !0;
        for (var s in n) {
      ...
      (m.reset = function () {
        ...
        Array.from(m.form.querySelectorAll("." + s)).map(function (e) {
          ...
          Array.from(m.form.querySelectorAll("." + m.config.classTo)).map(
            function (e) {
              e.classList.remove(m.config.successClass),
                e.classList.remove(m.config.errorClass);
            }
          );
      }),
      (m.destroy = function () {
        m.reset(),
          m.fields.forEach(function (e) {
